...
function preload(){  
  ...
  img2022 = loadImage("pictures/2022_tjw.jpg");
}
...
function draw() {
  ...
  if (img2022) {
    imageMode(CENTER);
    let imgW = width * 0.9;
    let imgH = (img2022.height / img2022.width) * imgW;
    image(img2022, width/2, height/2 - 250, imgW, imgH);
  }
...
function Header(){
  ...
  fill(255);
  rect(70, 1830, 1050, 250, 20);
  textSize(60);
  fill(0);
  text("2022年: 你说五条很帅，还一直调侃", 100, 1900);
   text("娜娜明是大叔。但五条也是", 100, 2000);
}

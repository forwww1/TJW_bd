...
function preload(){  
  ...
  img2024 = loadImage("pictures/2024_tjw.jpg");
...
function draw() {
  ...
  if (img2024) {
    imageMode(CENTER);
    let imgW = width * 0.9;
    let imgH = (img2024.height / img2024.width) * imgW;
    image(img2024, width/2, height/2-600, imgW, imgH);
  }
...
function Header(){
  ...
  fill(255);
  rect(70, 1100, 1050, 200, 20);
  textSize(60);
  fill(0);
  text("2024年: 你那时候说你在拉屎，我的天", 100, 1180);

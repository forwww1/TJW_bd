...
function preload(){  
  ...
  img2021 = loadImage("pictures/2021_tjw.jpg");
}
...
function draw() {
  ...
  if (img2021) {
    imageMode(CENTER);
    let imgW = width * 0.9;
    let imgH = (img2021.height / img2021.width) * imgW;
    image(img2021, width/2, height/2 - 250, imgW, imgH);
  }
...
function Header(){
  ...
  fill(255);
  rect(70, 1830, 1050, 170, 20);
  textSize(70);
  fill(0);
  text("2021年: 你很迷狐狸面具+狮子头", 100, 1900);
}
